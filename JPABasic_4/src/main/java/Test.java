...
//			em.persist(e);
//			
//			// flush() 1차 캐쉬에 관리되는 엔티티 객체의 snapshot 부터 dirty check 변화 부분들을 DB 에 반영
//			// flush() 가 insert-update 자체에 변화를 주지 않는다. 
//			// <= em.flush() 가 있어도, 없어도 insert-update 로 처리.
//			
...
//			
//			// 10 초 대기
//			Thread.sleep(10000); // MySql Workbench 에서 select 확인 X <= READ COMMITED, 10 초 후, commit 수행되고 확인 O			
//			System.out.println("After Flush");
//			
//			e.setName("AfterFlush");
//		}		
